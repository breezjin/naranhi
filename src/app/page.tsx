...
export default function Home() {
  return (
    <main className='p-8 pt-52 flex w-full min-h-[calc(100vh-65px)] flex-col items-center'>
      ...
      <div className='mt-32 flex gap-1 text-lg' data-aos='fade-zoom-in' data-aos-delay='1000'>
