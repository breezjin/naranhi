...
export default function Home() {
  return (
    <main
      className={cn('p-8 flex flex-col justify-center items-center w-full min-h-[calc(100vh-65px)]')}>
      ...
      <div className='mt-32 max-lg:mt-16 flex gap-1 text-lg' data-aos='fade-zoom-in' data-aos-delay='1000'>
      ...
      <div className='mt-4 flex gap-1 text-xl'>
        <div className='text-naranhiYellow' data-aos='fade-zoom-in' data-aos-duration='1500' data-aos-delay='1800'>8월29일 부터</div>
        <div className='' data-aos='fade-zoom-in' data-aos-duration='3000' data-aos-delay='2500'>진료를 시작 합니다.</div>
      </div>
    </main>
  );
}
