  ...
  return (
    ...
    >
      <div className='flex flex-col' data-aos='fade-zoom-in'>
        ...
        <p className='flex flex-wrap'>너무 뜨거워서 다른 사람이 부담스러워하지도 않고</p>
        <p className='flex flex-wrap'>너무 차가워서 다른 사람이 상처받지도 않는 온도는</p>
        <p className='flex flex-wrap'>&quot;따뜻한&quot;이라는 온도란 생각이 든다.</p>
        <p className='flex flex-wrap'>
      ...
      >
        <p className=''>나란히</p>
        <p className='' data-aos='fade-zoom-in' data-aos-delay='1000' data-aos-duration='2000'>
          정신건강의학과의원
        </p>
      </div>
      <div
