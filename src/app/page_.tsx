  ...
  return (
    <main className='flex min-h-screen w-full flex-col items-center justify-center'>
      <div className='m-8 flex flex-col'>
        ...
        <div className='flex flex-wrap'>
          너무 뜨거워서 다른 사람이 부담스러워하지도 않고, 너무 차가워서 다른 사람이 상처받지도 않는
          온도는
        </div>
      ...
      <div className='flex justify-center gap-2'>
        ...
        <div className='mb-2 text-4xl font-bold'>나란히</div>
      </div>
      <div className='text-2xl'>정신건강의학과의원</div>
      <div className='text-2xl'>& 심리발달센터</div>
      <div className='m-8 text-2xl'>
        <span className='font-semibold text-yellow-600'>9월</span>에 오픈 합니다.
      </div>
      <div className='mb-8 flex gap-4 text-slate-500'>
        <ArrowLink href='https://blog.naver.com/naranhiclinic/223157652333'>
          나란히 개원 이야기
        </ArrowLink>
      </div>
