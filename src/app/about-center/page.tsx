...
export default function Home() {
  return (
    ...
    >
      <Card className='h-fit max-lg:max-w-full lg:w-[31%]' data-aos='fade-zoom-in'>
        <CardHeader>
          <CardTitle className='text-naranhiYellow dark:text-naranhiGreen'>언어치료</CardTitle>
          <CardDescription>
            <div>“그늘의 나무도 때가 오면 꽃이 핀다.”</div>
            <div>언어 발달의 지연, 조음 장애, 질적인 의사소통 문제, 말더듬 등</div>
            <div>
        ...
        <CardContent className='space-y-1 text-sm'>
          ...
          <div>
            <ol className='list-decimal'>
              ...
              <li>말을 더듬거나 부적절한 속도 및 리듬으로 인해 말의 흐름이 부드럽지 않은 경우</li>
              <li>
                지적장애, 자폐성 범주장애, 정서장애, 발달장애 등으로 의사소통에 어려움을 겪는 경우
              </li>
            </ol>
          </div>
        </CardContent>
        <CardContent className='space-y-1 text-sm'>
          ...
          <div>
            <ol className='list-decimal'>
              ...
              <li>
                전문적 지식을 갖춘 언어치료사가 언어발달 평가 및 진단을 통하여 아동을 정확히
                파악합니다.
              </li>
              <li>정신과 전문의의 언어평가 결과 해석 상담 후 치료에 대한 계획을 수립합니다.</li>
              <li>
                아동 맞춤 <span className='italic'>Individual Education Plan</span> 장단기 계획 수및
                치료 목표 설정합니다.
              </li>
              <li>치료 프로그램 진행 : 회기당 40분(치료) + 10분(보호자 면담) </li>
      ...
      <Card
        className='h-fit max-lg:max-w-full lg:w-[31%]'
        data-aos='fade-zoom-in'
        data-aos-delay='100'
      >
        <CardHeader>
          <CardTitle className='text-naranhiYellow dark:text-naranhiGreen'>놀이치료</CardTitle>
          <CardDescription>
            <div>
        ...
        <CardContent className='space-y-1 text-sm'>
          ...
          <div>
            <ol className='list-decimal'>
              ...
              <li>강박적인 습관이나 화, 부정적인 감정을 조절하는데 어려움을 겪는 경우</li>
        ...
        <CardContent className='space-y-1 text-sm'>
          ...
          <div>
            <ol className='list-decimal'>
              <li>자신감은 물론 주위환경에 보다 잘 대처해나갈 수 있는 능력을 증진시켜 줍니다.</li>
              <li>훈련된 상담자와의 놀이를 통해 새로운 대인관계의 어려움을 극복시켜 줍니다.</li>
              <li>
                충동적이며 산만함을 조절할 수 있는 방법을 배우게 되고 긍정적인 사고를 할 수 있게
                도와줍니다.
              </li>
              <li>새로운 역할과 행동을 경험하게 하여 바람직한 사회화를 촉진하도록 도와줍니다.</li>
              <li>
                아동의 내적인 문제뿐 아니라 아동의 행동이 잘 변화될 수 있도록 부모양육상담 코칭을
                제공합니다.
              </li>
              <li>
                발달이 늦은 아동들은 여러 자극을 통해 전반적인 기능이 향상되는 경험을 하게 해줍니다.
              </li>
            </ol>
          </div>
        </CardContent>
        <CardContent className='space-y-1 text-sm'>
          ...
          <div>
            <ol className='list-decimal'>
              ...
              <li>전문의의 심리 검사(놀이 평가) 및 해석 상담이 이루어집니다.</li>
              <li>치료 프로그램 진행 : 회기당 40분(치료) + 10분(보호자 상담) </li>
              <li>필요시, 부모양육 코칭, history taking 상담 약 5~10회가 진행됩니다.</li>
              <li>보호자 면담을 통한 치료 프로그램 종결</li>
            </ol>
          </div>
        </CardContent>
      ...
      >
        <CardHeader>
          <CardTitle className='text-naranhiYellow dark:text-naranhiGreen'>인지치료</CardTitle>
          <CardDescription>
            <div>
        ...
        <CardContent className='space-y-1 text-sm'>
          ...
          <div>
            <ol className='list-decimal'>
              ...
              <li>ADHD, 언어발달 지연, 발달장애 등의 문제로 학습 능력 수준이 낮은 경우</li>
              <li>읽기장애, 쓰기장애, 산수학습장애가 나타나는 경우</li>
              <li>
                우울, 불안 등의 정서 장애를 동반하여 학교 생활이나 또래 관계에서 어려움을 겪는 경우
              </li>
            </ol>
          </div>
        </CardContent>
        <CardContent className='space-y-1 text-sm'>
          ...
          <div>
            <ol className='list-decimal'>
              <li>
                정신과 전문의 진료 후 필요한 검사(종합심리검사, 발달평가, 지능검사, 언어평가 등)를
                시행합니다.
              </li>
              <li>전문의의 검사 해석 상담, 아이에게 필요한 치료를 권고합니다.</li>
              ...
              <li>
                읽기 및 쓰기 능력, 주의집중, 개념형성, 수리 및 추리능력의 발달, 기억력을
                향상시킵니다.
              </li>
      ...
      >
        <CardHeader>
          <CardTitle className='text-naranhiYellow dark:text-naranhiGreen'>청소년 상담</CardTitle>
          <CardDescription>
            <div>
      ...
      >
        <CardHeader>
          <CardTitle className='text-naranhiYellow dark:text-naranhiGreen'>성인 상담</CardTitle>
          <CardDescription>
            <div>
              “다들 평생을 뭘 가져 보겠다고 고생 고생을 하면서 나는 어떤 인간이다라는 걸 보여주기
              위해서 아등바등 사는데 뭘 갖는 건지도 모르겠고 어떻게 원하는 걸 갖는다고 해도 나를
              안전하게 만들어 준다고 생각했던 것들에 나라고 생각했던 것들에 금이 가기 시작하면
              못견디고 무너지고...”
      ...
      >
        <CardHeader>
          <CardTitle className='text-naranhiYellow dark:text-naranhiGreen'>검사 프로그램</CardTitle>
          <CardDescription>
            <div>각 개인의 어려움과 상황에 맞는 다양한 평가 및 검사를 진행합니다.</div>
          </CardDescription>
        </CardHeader>
        <CardContent className='space-y-1 text-sm'>
        ...
        <CardFooter>
          <UnstyledLink href={'/about-center/non-reimbursement'} className='text-sm text-gray-500'>
            기타 비급여항목 안내
          </UnstyledLink>
        </CardFooter>
      </Card>
