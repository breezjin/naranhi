  ...
  return (
    <main
      className={cn(
        ...
        'flex flex-col flex-wrap justify-center gap-8',
        'max-lg:flex-col'
      )}
    >
      <Accordion type='single' collapsible>
        <AccordionItem value='item-1'>
          <AccordionTrigger>언어치료</AccordionTrigger>
          <AccordionContent>
              ...
              <CardContent className='space-y-1 text-sm'>
                ...
                <div>
                  <ol className='list-decimal'>
                    ...
                    <li>
                      말을 더듬거나 부적절한 속도 및 리듬으로 인해 말의 흐름이 부드럽지 않은 경우
                    </li>
                    <li>
                      지적장애, 자폐성 범주장애, 정서장애, 발달장애 등으로 의사소통에 어려움을 겪는
                      경우
                    </li>
                  </ol>
                </div>
              ...
              <CardContent className='space-y-1 text-sm'>
                ...
                <div>
                  <ol className='list-decimal'>
                    ...
                    <li>
                      정신과 전문의의 언어평가 결과 해석 상담 후 치료에 대한 계획을 수립합니다.
                    </li>
                    <li>
                      아동 맞춤 <span className='italic'>Individual Education Plan</span> 장단기
                      계획 수및 치료 목표 설정합니다.
                    </li>
      ...
      <Accordion type='single' collapsible>
        <AccordionItem value='item-2'>
          <AccordionTrigger>놀이치료</AccordionTrigger>
          <AccordionContent>
            <Card
            ...
            >
              ...
              <CardContent className='space-y-1 text-sm'>
                ...
                <div>
                  <ol className='list-decimal'>
                    <li>
                      자신감은 물론 주위환경에 보다 잘 대처해나갈 수 있는 능력을 증진시켜 줍니다.
                    </li>
                    <li>
                      훈련된 상담자와의 놀이를 통해 새로운 대인관계의 어려움을 극복시켜 줍니다.
                    </li>
                    <li>
                      충동적이며 산만함을 조절할 수 있는 방법을 배우게 되고 긍정적인 사고를 할 수
                      있게 도와줍니다.
                    </li>
                    <li>
                      새로운 역할과 행동을 경험하게 하여 바람직한 사회화를 촉진하도록 도와줍니다.
                    </li>
                    <li>
                      아동의 내적인 문제뿐 아니라 아동의 행동이 잘 변화될 수 있도록 부모양육상담
                      코칭을 제공합니다.
                    </li>
                    <li>
                      발달이 늦은 아동들은 여러 자극을 통해 전반적인 기능이 향상되는 경험을 하게
                      해줍니다.
                    </li>
                  </ol>
                </div>
      ...
      <Accordion type='single' collapsible>
        <AccordionItem value='item-3'>
          <AccordionTrigger>인지치료</AccordionTrigger>
          <AccordionContent>
            <Card
              key='인지치료'
              className='h-fit max-lg:max-w-full lg:w-[31%]'
            ...
            >
              <CardHeader>
                ...
                <CardDescription>
                  ...
                  <br />
                  <div>
                    아동의 지적 수준과 주의력 등의 학습에 저해를 주는 인지적인 요인들을
                    인지학습치료적 접근 방법을 통하여 아동의 인지 발달을 촉진시키는 치료입니다.
                  </div>
                </CardDescription>
              </CardHeader>
              <CardContent className='space-y-1 text-sm'>
                ...
                <div>
                  <ol className='list-decimal'>
                    ...
                    <li>
                      우울, 불안 등의 정서 장애를 동반하여 학교 생활이나 또래 관계에서 어려움을 겪는
                      경우
                    </li>
                  </ol>
                </div>
              ...
              <CardContent className='space-y-1 text-sm'>
                ...
                <div>
                  <ol className='list-decimal'>
                    <li>
                      정신과 전문의 진료 후 필요한 검사(종합심리검사, 발달평가, 지능검사, 언어평가
                      등)를 시행합니다.
                    </li>
      ...
      <Accordion type='single' collapsible>
        <AccordionItem value='item-4'>
          <AccordionTrigger>청소년 상담</AccordionTrigger>
          <AccordionContent>
            <Card
              key='청소년 상담'
              className='h-fit max-lg:max-w-full lg:w-[31%]'
              ...
              <CardHeader>
                ...
                <CardDescription>
                  <div>
                    ...
                    생각이 들기도 해. 내가 한결 같은 앤이라면 훨씬 더 편하겠지만 재미는 지금의
                    절반밖에 되지 않을거야.“
                    <span className='font-sans italic text-gray-500'> - 빨강머리 앤</span>
                  </div>
                  <br />
                  <div>
                    청소년기는 가치관, 정체성을 세워나가는 시기로, 신체적, 정신적으로 급격히
                    성장하는 과정을 겪으며 어려움을 겪기 쉽습니다. 상담을 통해 어려움을 함께 겪어
                    나가고 더불어 성장의 기회로 삼는 것을 목표로 합니다.
                  </div>
                </CardDescription>
              </CardHeader>
              <CardContent className='space-y-1 text-sm'>
      ...
      <Accordion type='single' collapsible>
        <AccordionItem value='item-5'>
          <AccordionTrigger>성인 상담</AccordionTrigger>
          <AccordionContent>
            <Card
              key='성인 상담'
              className='h-fit max-lg:max-w-full lg:w-[31%]'
              ...
              <CardHeader>
                ...
                <CardDescription>
                  <div>
                    ...
                    보여주기 위해서 아등바등 사는데 뭘 갖는 건지도 모르겠고, 어떻게 원하는 걸
                    갖는다고 해도{` `}
                  ...
                  <br />
                  <div>
                    현대 사회에서 성인이 된 우리는 수많은 역할과 책임을 가지게 됩니다. 그 속에서
                    갈등과 스트레스, 어려움을 겪을 수 있습니다. 상담을 통하여 어려움을 나누고 자기
                    돌봄과 성장의 기회가 되는 것을 목표로 삼습니다.
                  </div>
                </CardDescription>
              </CardHeader>
              <CardContent className='space-y-1 text-sm'>
      ...
      <Accordion type='single' collapsible>
        <AccordionItem value='item-6'>
          <AccordionTrigger>검사 프로그램</AccordionTrigger>
          <AccordionContent>
            <Card
              key='검사 프로그램'
              className='h-fit max-lg:max-w-full lg:w-[31%]'
