            ...
            >
              <CardHeader>
                ...
                <CardDescription>
                  ...
                  <div>
                    전반적인 의사소통에 어려움을 겪는 아동이 의사소통을 원활하게
                    할 수 있도록 돕는 치료프로그램입니다.
                  </div>
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-1 text-sm">
                ...
                <div>
                  <ol className="list-decimal">
                    <li>
                      정신과 전문의 초진 후 언어치료 필요 여부 결정합니다.
                    </li>
                    <li>
                      전문적 지식을 갖춘 언어치료사가 언어발달 평가 및 진단을
                      통하여 아동을 정확히 파악합니다.
                    </li>
                    <li>
                      정신과 전문의의 언어평가 결과 해석 상담 후 치료에 대한
                      계획을 수립합니다.
                    </li>
                    <li>
                      아동 맞춤{' '}
                      <span className="italic">Individual Education Plan</span>{' '}
                      장단기 계획 수및 치료 목표 설정합니다.
                    </li>
                    <li>
            ...
            >
              <CardHeader>
                ...
                <CardDescription>
                  ...
                  <br />
                  <div>
                    아동에게 가장 친숙한 활동인 놀이를 통해 정서적 문제를
                    해결하고 성장과 발달을 촉진시키기 위해 활용되는
                    상담치료기법입니다.
                  </div>
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-1 text-sm">
                ...
                <div>
                  <ol className="list-decimal">
                    ...
                    <li>
                      강박적인 습관이나 화, 부정적인 감정을 조절하는데 어려움을
                      겪는 경우
                    </li>
              ...
              <CardContent className="space-y-1 text-sm">
                ...
                <div>
                  <ol className="list-decimal">
                    ...
                    <li>
                      충동적이며 산만함을 조절할 수 있는 방법을 배우게 되고
                      긍정적인 사고를 할 수 있게 도와줍니다.
                    </li>
                    <li>
                      새로운 역할과 행동을 경험하게 하여 바람직한 사회화를
                      촉진하도록 도와줍니다.
                    </li>
                    <li>
                      아동의 내적인 문제뿐 아니라 아동의 행동이 잘 변화될 수
                      있도록 부모양육상담 코칭을 제공합니다.
                    </li>
                    <li>
                      발달이 늦은 아동들은 여러 자극을 통해 전반적인 기능이
                      향상되는 경험을 하게 해줍니다.
                    </li>
                  </ol>
                </div>
              ...
              <CardContent className="space-y-1 text-sm">
                ...
                <div>
                  <ol className="list-decimal">
                    <li>
                      정신과 전문의 진료 후 놀이치료 필요 여부 결정합니다.
                    </li>
                    <li>
                      스케쥴 예약 및 선결제 진행(필요시 놀이평가를 진행합니다.)
                    </li>
                    <li>
              ...
              <CardHeader>
                ...
                <CardDescription>
                  ...
                  <div>
                    ...
                    요인들을 인지학습치료적 접근 방법을 통하여 아동의 인지
                    발달을 촉진시키는 치료입니다.
                  </div>
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-1 text-sm">
                ...
                <div>
                  <ol className="list-decimal">
                    ...
                    <li>
                      ADHD, 언어발달 지연, 발달장애 등의 문제로 학습 능력 수준이
                      낮은 경우
                    </li>
                    <li>읽기장애, 쓰기장애, 산수학습장애가 나타나는 경우</li>
                    <li>
                      우울, 불안 등의 정서 장애를 동반하여 학교 생활이나 또래
                      관계에서 어려움을 겪는 경우
                    </li>
                  </ol>
                </div>
              ...
              <CardContent className="space-y-1 text-sm">
                ...
                <div>
                  <ol className="list-decimal">
                    ...
                    <li>
                      치료프로그램 진행 : 회기당 40분(치료) + 10분(보호자면담)
                    </li>
                    <li>
                      읽기 및 쓰기 능력, 주의집중, 개념형성, 수리 및 추리능력의
                      발달, 기억력을 향상시킵니다.
                    </li>
          ...
          <AccordionContent>
            ...
            >
              <CardHeader>
                ...
                <CardDescription>
                  <div>
                    “내 속엔 여러가지 앤이 들어있나봐. 가끔씩은 난 왜 이렇게
                    골치 아픈 존재인가 하는 생각이 들기도 해. 내가 한결 같은
                    앤이라면 훨씬 더 편하겠지만 재미는 지금의 절반밖에 되지
                    않을거야.“
                    <span className="font-sans italic text-gray-500">
                      {' '}
                      - 빨강머리 앤
                  ...
                  <br />
                  <div>
                    청소년기는 가치관, 정체성을 세워나가는 시기로, 신체적,
                    정신적으로 급격히 성장하는 과정을 겪으며 어려움을 겪기
                    쉽습니다. 상담을 통해 어려움을 함께 겪어 나가고 더불어
              ...
              <CardContent className="space-y-1 text-sm">
                ...
                <div>
                  <ol className="list-decimal">
                    ...
                    <li>
                      청소년 상담 진행 : 회기당 40분(치료) + 10분(보호자면담)
                    </li>
              ...
              <CardHeader>
                ...
                <CardDescription>
                  <div>
                    ...
                    라는 걸 보여주기 위해서 아등바등 사는데 뭘 갖는 건지도
                    모르겠고, 어떻게 원하는 걸 갖는다고 해도{` `}
                    <span className="font-semibold">
                      나를 안전하게 만들어 준다고 생각했던 것들에, 나라고
                      생각했던 것들
                    </span>
                  ...
                  <br />
                  <div>
                    현대 사회에서 성인이 된 우리는 수많은 역할과 책임을 가지게
                    됩니다. 그 속에서 갈등과 스트레스, 어려움을 겪을 수
                    있습니다. 상담을 통하여 어려움을 나누고 자기 돌봄과 성장의
                    기회가 되는 것을 목표로 삼습니다.
                  </div>
                </CardDescription>
              </CardHeader>
          ...
          <AccordionContent>
            ...
            >
              <CardHeader>
                ...
                <CardDescription>
                  <div>
                    각 개인의 어려움과 상황에 맞는 다양한 평가 및 검사를
                    진행합니다.
                  </div>
                </CardDescription>
              </CardHeader>
