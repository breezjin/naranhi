...
export const Tabs = ({
  ...
  return (
    <>
      <div
        className={cn(
          'relative flex w-full max-w-full flex-wrap items-center justify-start overflow-auto [perspective:1000px] sm:overflow-visible',
          containerClassName
        )}
      >
        {/* <div
      ...
      <FadeInDiv
        ...
        key={active.value}
        hovering={hovering}
        className={cn('mt-24 max-lg:mt-32', contentClassName)}
      />
    </>
  );
};
