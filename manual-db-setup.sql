-- 공지사항 시스템 데이터베이스 테이블 생성
-- Manual Database Setup for Notices System
...
-- 2. Create or replace notices table with full schema
...
-- 6. Insert default notice categories
...
-- 7. Insert sample notices for testing
INSERT INTO notices (
  title, 
  content, 
  html_content, 
