...
- navigation:
  - link "네이버 블로그":
    - /url: https://blog.naver.com/naranhiclinic
    - img "네이버 블로그"
  - link "카카오 채널":
    - /url: http://pf.kakao.com/_VAAlG
    - img "카카오 채널"
  - link "인스타그램":
    - /url: https://www.instagram.com/naranhi_clinic
    - img "인스타그램"
  - button "Toggle theme":
    - img
    - img
...
- link "02) 6484-8111":
  - /url: tel:0264848111
- text: 주소 서울특별시 동작구 현충로 75, 3층 (흑석동, 원불교100년기념관 및 역사문화기념관 2-1호) Since 2023, Copyright ©2025 Naranhi Mental Health Clinic. All Right Reserved. xl
- alert
```